...
async function runPhase29Audit() {
  console.log('===========================================================');
  console.log(' CONSTRUCTIONS PHASE 29 — LIVE MARKET MONITORING & TERMINAL AUDIT');
  console.log('===========================================================');
  ...
  if (hasMarketInSitemap && hasChangesInSitemap) {
    console.log('  ✓ sitemap.ts incorporates all Phase 29 public intelligence surfaces.');
  } else {
  ...
  if (allPassed) {
    console.log('===========================================================');
    console.log('✅ PHASE 29 LIVE MARKET MONITORING & TERMINAL AUDIT PASSED 100%');
    console.log('===========================================================');
  } else {
    console.error('===========================================================');
    console.error('❌ PHASE 29 LIVE MARKET MONITORING & TERMINAL AUDIT FAILED ');
    console.error('===========================================================');
    process.exit(1);
  }
}
