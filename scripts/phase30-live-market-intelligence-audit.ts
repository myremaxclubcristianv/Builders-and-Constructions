...
async function runPhase30Audit() {
  console.log('===========================================================');
  console.log(' CONSTRUCTIONS PHASE 30 — LIVE MARKET INTELLIGENCE & CHANGE AUDIT');
  console.log('===========================================================');

  // [1/10] BASELINE DATASET DEPTH AUDIT
  ...
  console.log('\n[1/10] BASELINE DATASET DEPTH & COUNT INTEGRITY:');
  ...
  // [2/10] PRODUCT SURFACES INTEGRITY AUDIT
  console.log('\n[2/10] PRODUCT SURFACES INTEGRITY AUDIT:');
  const requiredPages = [
    'app/market/page.tsx',
  ...
  console.log('\n[3/10] PROVENANCE LEDGER & NON-FABRICATION AUDIT:');
  ...
  // [4/10] COMMERCIAL NEUTRALITY AUDIT
  console.log('\n[4/10] COMMERCIAL NEUTRALITY & PROXY LEAD LANGUAGE AUDIT:');
  ...
  // [5/10] YOUTUBE SOURCE LOCK AUDIT
  console.log('\n[5/10] YOUTUBE OFFICIAL SOURCE LOCK AUDIT:');
  ...
  // [6/10] PROJECT INVESTMENT LABEL RENDERING AUDIT
  console.log('\n[6/10] PROJECT INVESTMENT LABEL RENDERING BUG AUDIT:');
  let rawLabelBugs = 0;
  for (const p of realProjectsDataset) {
  ...
  // [7/10] TELEGRAM SERVER-SIDE CREDENTIAL AUDIT
  console.log('\n[7/10] TELEGRAM SERVER-SIDE CREDENTIAL AUDIT:');
  ...
  // [8/10] WATCHLIST ANONYMOUS LOCALSTORAGE AUDIT
  console.log('\n[8/10] WATCHLIST LOCALSTORAGE & PRIVACY AUDIT:');
  ...
  // [9/10] SITEMAP & NOINDEX AUDIT
  console.log('\n[9/10] SITEMAP & NOINDEX INTEGRITY AUDIT:');
  ...
  if (hasMarketInSitemap && hasChangesInSitemap) {
    console.log('  ✓ sitemap.ts incorporates all Phase 30 public intelligence surfaces.');
  } else {
  ...
  if (allPassed) {
    console.log('===========================================================');
    console.log('✅ PHASE 30 LIVE MARKET INTELLIGENCE & CHANGE AUDIT PASSED 100%');
    console.log('===========================================================');
  } else {
    console.error('===========================================================');
    console.error('❌ PHASE 30 LIVE MARKET INTELLIGENCE & CHANGE AUDIT FAILED ');
    console.error('===========================================================');
    process.exit(1);
  }
}
